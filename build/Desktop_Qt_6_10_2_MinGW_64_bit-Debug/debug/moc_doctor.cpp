...
template <> constexpr inline auto Doctor::qt_create_metaobjectdata<qt_meta_tag_ZN6DoctorE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_comboBoxDepartment_activated",
        "index",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_comboBoxDepartment_activated'
        QtMocHelpers::SlotData<void(int)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 6 },
        }}),
        // Slot 'loadDepartmentsFromDb'
...
void Doctor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_comboBoxDepartment_activated((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->loadDepartmentsFromDb(); break;
        default: ;
        }
    }
}
